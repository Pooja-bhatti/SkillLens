...
const questionsSchema = new mongoose.Schema({
    ...
    timeLimit: Number,
    timeConstraint: Number, // MS limit for execution
    spaceConstraint: Number, // MB limit for execution
    variableConstraints: [String], // Textual constraints
    mustHave: [String],     // Expected concept phrases used for semantic evaluation
    testCases: [{           // Test cases for coding questions (generated by LLM)
        input: String,          // stdin input for the test case
